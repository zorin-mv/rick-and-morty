...
export const TextComponent = memo(
  ({ className, title, text, subTitle, theme = 'primary', align = 'left', isInline }: ITextProps) => (
    <div
      data-testid="text-wrapper"
      className={classNames(
        classes.textWrapper,
        [className, classes[`textWrapper_${theme}`], classes[`textWrapper_${align}`]],
        { [classes.textWrapper_inline]: isInline }
      )}
    >
